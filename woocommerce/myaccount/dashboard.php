...
<div class="account-info">
	<div class="info-type">
		<?php if(get_locale() == 'uk'){echo "Ім'я";}elseif(get_locale() == 'ru_RU'){echo 'Имя';} else {echo "Ім'я";} ?>
	</div>
	<div class="info">
...
<div class="account-info">
	<div class="info-type">
		<?php if(get_locale() == 'uk'){echo "Адреса доставки";}elseif(get_locale() == 'ru_RU'){echo 'Адрес доставки';} else {echo "Адреса доставки";} ?>
	</div>
	<div class="info">
